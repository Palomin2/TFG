...
/******************************************************************************* */
iMatrix<std::vector<double>> CurveDerivsCpts(int n, int p,const std::vector<double> &KnotVector,const iMatrix<double> &CtrlPts,  int d,
    int r1, int r2){
    int r= r2-r1;
...
/******************************************************************************* */
std::vector<double> SurfacePoint(int n1, int p1,const std::vector<double> &KnotVector1, int n2, int p2,
    const std::vector<double> &KnotVector2,const std::vector<iMatrix<double>> &CtrlPts, double t1, double t2){
...
/******************************************************************************* */
std::vector<double> CurvePointRational(int n, int p,const std::vector<double> &KnotVector,
    const iMatrix<double> &CtrlPtsWeighted, double t){
    int span =FindSpan(KnotVector, t, p, n);
    std::vector<double> Funs = BasisFuns(span,t,p,KnotVector);
...
/******************************************************************************* */
std::vector<double> RationalBasisFuns(int i, double t, int p,const std::vector<double> &KnotVector,
...
/******************************************************************************* */
iMatrix<double> RatDersBasisFuns(int i, double t, int p, int k,  const std::vector<double> &KnotVector,
    const std::vector<double> &WeightVector){
...
/******************************************************************************* */
iMatrix<double> RationalizeDersBasisFuns(int i, double t, int p, int k,  const std::vector<double> &KnotVector,
    const iMatrix<double> &ders , const std::vector<double> &WeightVector){
    iMatrix<double> R_ders(k+1, p+1);
...
/******************************************************************************* */
iMatrix<double> CurveKnotsIns(int np, int p, std::vector<double> &KnotVector,const iMatrix<double> &CtrlPtsW, 
    double u, int index, int s, int r){
    //int mp = np+p+1;
...
/******************************************************************************* */
iMatrix<double> RefineKnotVectCurve(int n, int p, std::vector<double> &KnotVector,
    const iMatrix<double> &CtrlPtsW,const std::vector<double> &Insertions, int r){
    int m=n+p+1;
    int dim=CtrlPtsW.GetNumRows();
...
/******************************************************************************* */
std::vector<iMatrix<double>> RefineKnotVectSurface(int np1, int p1, std::vector<double> &KnotVector1, 
    int np2, int p2, std::vector<double> &KnotVector2,const std::vector<iMatrix<double>> &CtrlPtsW, bool dir,
...
void D1_element_eval(int n, int i, int p, int nEvals, double lower_limit, double upper_limit,const std::vector<double> &KnotVector,
    ...
    double &preEvalPoint, double &cumLenght, iMatrix<double> &BasisFunsEvals, iMatrix<double> &DerBasisFunsEvals,
    std::vector<double>& JacobianEvals, std::vector<double>& InverseJacobianEvals, std::vector<double>& funcEvals, double Lenght){
...
std::vector<double> gauss_legendre_cuadrature_integral_linealForm(int p, double lower_limit, double upper_limit, 
    int nEvals,const iMatrix<double> &BasisFunsEvals,const std::vector<double>& JacobianEvals,
    const std::vector<double>& funcEvals,const Eigen::VectorXd &weights){
    std::vector<double> sol(p+1);
    double AuxConstant = (upper_limit-lower_limit)/2;
...
void impose_Dirichlet_Condition(int p, int size, Eigen::SparseMatrix<double> &global, Eigen::VectorXd &LinearForm, 
    bool Modify0, bool Modify1, double ValueAt0, double ValueAt1){
    if(Modify0){
...
/******************************************************************************* */
void impose_Robin_Condition(int p, int size, Eigen::SparseMatrix<double> &global, Eigen::VectorXd &LinearForm, 
    double alpha, double beta, bool Modify0, bool Modify1, double ValueAt0, double ValueAt1){
...
/******************************************************************************* */
void writeNumericFunction(Eigen::VectorXd funEvals,const std::vector<double> &KnotVector,const std::vector<double> &WeightVector, int n, 
    int p, int nEvals, double lowerLimit, double upperLimit, std::string name,std::vector<double> Intervals, int nElements, double Lenght){
...
/******************************************************************************* */
void writeAnalyticFunction(std::function<double(double)> f,std::function<double(double)> f_Ders, std::vector<double> Intervals, 
    double nEvals,const iMatrix<double> &CtrlPtsW,const std::vector<double> &KnotVector, int n, int p, 
    std::string name, double Lenght, double nElements){
...
/******************************************************************************* */
std::vector<std::vector<iMatrix<double>>> PreBasis_and_Ders(int p, int k, std::vector<double> KnotVector, 
    std::vector<double> Intervals,Eigen::VectorXd nodes, std::vector<int>& spanIndex){
...
/******************************************************************************* */
std::vector<iMatrix<double>> RationalizeDersBasisFunsVec(int span, int nEvals, Eigen::VectorXd nodes, 
    double lower_limit, double upper_limit,int p, int k, int n, std::vector<double> KnotVector,
    std::vector<iMatrix<double>> Basis_and_DersY,std::vector<double> Weights){
