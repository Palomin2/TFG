...
%     end
    ...
    switch ( quadorder )
        ...
        case 4   %Corregido
            r1pt(1) = 0.861136311594053;      % 0.861134311594053;
            r1pt(2) =-0.861136311594053;      % -0.861134311594053;
        ...
        case 6 %comprobado
            ...
            r1pt(5) = 0.238619186083197; %%% lo he cambiado % ANTES: 0.238619186003152;
            r1pt(6) =-0.238619186083197; %%% lo he cambiado % ANTES:-0.238619186003152;
        ...
        case 9 % corregido
            ...
            r1wt(7) =  0.260610696402935; %corregido, antes ponia 0.261610696402935;
        ...
        otherwise
            [r1pt,r1wt]= gauleg(1,-1,quadorder); % gauleg no existe en matlab? 
