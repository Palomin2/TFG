...
*Output: iMatrix where the i-th row is the evaluation of the i-th derivate
*/
iMatrix<double> CurveDerivsAlg2(int n, int p,std::vector<double> &KnotVector, iMatrix<double> &CtrlPts, double t, int d);
...
/*
*Input: Aders: derivates of the CtrlPtsWeighted using CurvDersAlg1 evaluated at some t, wders: same as Aders but with the weighted vector, maximum degree of the derivate-1
